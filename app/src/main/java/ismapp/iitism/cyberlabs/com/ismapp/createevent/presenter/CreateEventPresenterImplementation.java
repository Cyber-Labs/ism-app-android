...
public class CreateEventPresenterImplementation implements CreateEventPresenterInterface {
    ...
    @Override
    public void getCreateEventRequest(String access_token, String club_id, String title, String short_description, String description, String venue, String event_start_date, String event_end_date, MultipartBody.Part image) {
